...
#define _DUTY_MAX 2800 // 2000
#define _DUTY_NEU 1440 // 1500
#define _DUTY_MIN 695 // 1000
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(50, 0.5, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 616 + (-2.06 * a_value) + (1.73e-3 * a_value * a_value);
}
